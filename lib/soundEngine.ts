// Synthetic Web Audio Engine for Rift Tactics
// Zero external file dependencies; purely browser-synthesized audio
...
class SoundEngine {
  ...
  public playLockIn() {
    ...
    // Chime chord: Hextech Lock-In (C5, G5, C6)
  ...
  public playDamageImpact(isCrit: boolean = false) {
    if (this.isMuted) return;
    this.initCtx();
    if (!this.ctx) return;
